...
/** The wordmark. A drum silhouette, not a coffee cup — this is production software. */
export function BrandMark({
  ...
  return (
    <span className={cn("inline-flex items-center gap-2", className)}>
      ...
      {showText ? <span className="font-semibold text-base tracking-tight">Roastery</span> : null}
    </span>
  );
}
