...
function Field({
  ...
  return (
    // A field IS a group — label, control, description and error read as one
    // thing — and <fieldset> is for a set of them, which is what FieldSet
    // above already is.
    // biome-ignore lint/a11y/useSemanticElements: fieldset is the wrong element for one field.
    <div
      role="group"
      data-slot="field"
