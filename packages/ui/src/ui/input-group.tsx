...
function InputGroupAddon({
  ...
  return (
    // Presentational: an icon or a unit label beside the control. The click
    // handler only widens the input's hit area, so it needs no keyboard
    // equivalent — Tab already reaches the input itself.
