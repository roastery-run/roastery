...
function ItemGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // Kept as shipped, but note that Item does NOT claim role="listitem", so
    // this pair announces as an empty list. Where the content really is a
    // list, use a <ul> and `<Item asChild><li>` instead — see the settings
    // screens.
    // biome-ignore lint/a11y/useSemanticElements: vendored as shipped; see above.
    <div
      role="list"
