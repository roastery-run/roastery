...
function ButtonGroup({
  ...
  return (
    // Genuinely a group of related controls, and there is no HTML element that
    // says so — <fieldset> is for form fields with a legend.
    // biome-ignore lint/a11y/useSemanticElements: no semantic element for a button group.
    <div
      role="group"
